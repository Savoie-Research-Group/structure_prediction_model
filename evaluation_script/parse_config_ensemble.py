...
def parse_config(args):
    if os.path.isfile(args.config) is False:
        ...
        exit()
    keywords = ['tgt_test','mode_lst','best_chk_path1','best_chk_path2','best_chk_path3','best_chk_path4','best_chk_path5','ch_to_idx_dict_path','idx_to_ch_dict_path','test_output_path','log_path','txt_path']
