...
ms_drop_list, ir_drop_list, nmr_drop_list, X_test = random_choice(spec_test,0.3)
write_drop(ms_drop_list,'ms_test_drop_0.3.txt')
write_drop(ir_drop_list,'ir_test_drop_0.3.txt')
write_drop(nmr_drop_list,'nmr_test_drop_0.3.txt')
