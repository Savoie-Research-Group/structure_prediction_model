...
import logging
from calc_smiles import bs_accuracy
...
for i in range(0,num_example,20):
    ...
    count_top1,count_top10,batch_pred = bs_accuracy(batch,model,tgt_maxlen,idx_to_ch_dict,target_start_token_idx,target_end_token_idx)
    correct_num_top1.append(count_top1)
    correct_num_top10.append(count_top10)
    pred_10 += batch_pred
